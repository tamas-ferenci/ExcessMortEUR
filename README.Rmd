...
ggplot(DemData[Country.Region=="Czechia"&date>="2020-09-16"&date<="2020-12-16"],
  ...
  scale_x_date(sec.axis = sec_axis(~., breaks = seq.Date(as.Date("2020-09-16"),
                                   ...
                                   labels = seq.Date(as.Date("2020-09-16"), as.Date("2020-12-16"),
...
ggplot(res[age=="TOTAL"&(nuts_level==3|geo=="HU")&sens==FALSE&ED=="ExAnte"&model=="quasipoisson"&
             date<="2023-07-01"],
...
ggplot(res[(nuts_level==3|geo=="HU")&age=="TOTAL"&sens==FALSE&ED=="ExPost"&model=="quasipoisson"&
             date=="2023-06-26"][order(cumexcess/meanpopulation)],
