...
```{r, message = FALSE, echo = FALSE}
res_flu <- rbindlist(lapply(list(`Eredeti` = exclude_dates,
                                 `Influenza-szezonok kizárásával` = exclude_dates_flu),
                            function(ed)
...
ggplot(res_flu, aes(x = date, y = cumexcess, color = .id, label = round(cumexcess, -2))) + geom_line() +
