...
ggplot(res[nuts_level==0], aes(x = date, y = excess/population*1e6, group = geo)) + geom_line() +
  labs(x = "", y = "Aktuális többlethalálozás [fő/1M fő]",
       caption = paste0(captionlab, format(Sys.Date(), "%Y. %m. %d."))) +
...
Látható, hogy a legfrissebb adatok szerint -- persze ne felejtsük, ez egy hónappal ezelőtti állapotot jelent! -- nagyjából a legrosszabb harmad közepén vagyunk.
...
ggplot(res[nuts_level==0, tail(.SD, 1), .(geo)][order(cumexcess/meanpopulation)],
...
ggplot(geodata[geodata$nuts_level==0,], aes(fill = y)) + geom_sf() +
  coord_sf(xlim = c(-25, 50), ylim = c(33, 73)) + scale_fill_gradient(low = "green", high = "red") +
...
ggplot(res[nuts_level==3|geo=="HU"], aes(x = date, y = excess/population*1e6,
...
ggplot(res[nuts_level==3], aes(x = date, y = excess/population*1e6, group = geo)) + geom_line() +
  labs(x = "", y = "Aktuális többlethalálozás [fő/1M fő]",
       caption = paste0(captionlab, format(Sys.Date(), "%Y. %m. %d."))) +
  scale_x_date(date_breaks = "2 months", labels = function(z) gsub("^0", "", strftime(z, "%m"))) +
...
ggplot(res[nuts_level==3|geo=="HU"], aes(x = date, y = cumexcess/meanpopulation*1e6,
...
ggplot(res[nuts_level==3, tail(.SD, 1), .(geo)][order(cumexcess/meanpopulation)],
...
ggplot(geodata[geodata$nuts_level==3,], aes(fill = y)) + geom_sf() +
