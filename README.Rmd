...
A számítások aktualizálásának dátuma: `r Sys.Date()`. A többlethalálozást számító csomag (`excessmort`) verziószáma `r packageVersion("excessmort")`, az Eurostat-tól adatokat lekérő csomagé (`eurostat`) `r packageVersion("eurostat")`.
